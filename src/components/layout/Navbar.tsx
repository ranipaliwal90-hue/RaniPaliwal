            ...
            >
              ...
              <motion.div
                ...
                className="
                  ...
                  rounded-full
                  bg-[#0F5132]
                  shadow-[0_6px_18px_rgba(15,81,50,0.18)]
                  ring-1
                  ring-emerald-100
                "
              >
            ...
            <div className="hidden shrink-0 items-center lg:flex">
              ...
              <Link
                ...
                className="
                  ...
                  font-bold
                  text-white
                  shadow-[0_7px_20px_rgba(15,81,50,0.18)]
                  transition-all
                  duration-300
                  hover:-translate-y-0.5
                  hover:bg-[#0B4329]
                  hover:shadow-[0_10px_24px_rgba(15,81,50,0.24)]
                  xl:px-4
                  xl:text-[13px]
                "
              >
          ...
          {mobileMenuOpen && (
            ...
            <motion.div
              ...
              className="
                ...
                border-emerald-100
                bg-white/95
                shadow-[0_20px_40px_rgba(15,81,50,0.10)]
                backdrop-blur-xl
                lg:hidden
              "
            >
